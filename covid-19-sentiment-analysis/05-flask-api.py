...
def submit():
    ...
    if true_count >= 3:
        con = 'More than half of the models predict your news is TRUE!' \
              ' Continue practicing social distancing, and wearing your mask. Please use common sense when judging the news and instructions you read. Always do what is safest for you and the people around you.'
    else:
